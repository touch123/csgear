...
ContentTypes['my_head'] = {
    -5 : {'content_type':'BCD',        'max_len': 4,    'len_type': 'fixed'},
    -4 : {'content_type':'BCD',        'max_len': 10,   'len_type': 'fixed'},
    -3 : {'content_type':'BCD',        'max_len': 4,    'len_type': 'fixed'},
    -2 : {'content_type':'BINARY',     'max_len': 64,   'len_type': 'fixed_b'}
}
...
ContentTypes['pos'] = {
    ...
    48 : {'content_type':'ASCII',        'max_len': 8,  'len_type': 'LLLVAR'},
    ...
    55 : {'content_type':'ASCII',        'max_len': 255,  'len_type': 'LLLVAR'},
    58 : {'content_type':'ASCII',        'max_len': 100,  'len_type': 'LLLVAR'},
    60 : {'content_type':'ASCII',        'max_len': 17,   'len_type': 'LLLVAR'},
